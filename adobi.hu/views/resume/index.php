	...
	<div id="resume-wrap">
		...
		<div id="personal-info">
			<dl>
				...
				<dt>Experience</dt>
				<dd class="experience">
					<h2><span></span> wizando.com <a href="http://wizando.com" target="_blank">&raquo;</a><span class="duration">2012 october-present</span></h2>
					...
					<h2><span></span> Invictus-Games Ltd.<a href="http://invictus.com" target="_blank">&raquo;</a><span class="duration">2010 july-2012 october</span></h2>
	          ...
	          <ul>
	            ...
	            <li>A social game(un-published). Role: development of an API for the client, a HTML and Javascript front-end and a back-end using CodeIgniter and MongoDB.</li>
					...
					<h2><span></span> Web-Server Ltd.<a href="http://web-server.hu" target="_blank">&raquo;</a><span class="duration">2008 december-2010 june</span></h2>
					<p class="position">Full-stack web developer.</p>
					<div class="details">
